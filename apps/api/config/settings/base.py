...
BILLING_SANDBOX_WEBHOOK_SECRET_REF = _env(
    "BILLING_SANDBOX_WEBHOOK_SECRET_REF", "SANDBOX_WEBHOOK_SECRET"
)
SANDBOX_PAYMENT_BASE_URL = _env("SANDBOX_PAYMENT_BASE_URL", "")
...
EMAIL_HOST_PASSWORD_REF = _env("EMAIL_HOST_PASSWORD_REF", "EMAIL_HOST_PASSWORD")
EMAIL_HOST_PASSWORD = SecretRef(EMAIL_HOST_PASSWORD_REF).resolve_optional()
EMAIL_USE_TLS = _env_bool("EMAIL_USE_TLS", True)
EMAIL_USE_SSL = _env_bool("EMAIL_USE_SSL", False)
PLATFORM_PORTAL_PUBLIC_URL = _env(
    "PLATFORM_PORTAL_PUBLIC_URL", "http://localhost:5173"
)
AGENCY_PORTAL_PUBLIC_URL = _env("AGENCY_PORTAL_PUBLIC_URL", "http://localhost:5174")
CUSTOMER_PORTAL_PUBLIC_URL = _env(
