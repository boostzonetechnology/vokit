...
KYC_ALLOW_HTTP_HOSTED = _env_bool("KYC_ALLOW_HTTP_HOSTED", True)
KYC_HOSTED_BASE_URL = _env("KYC_HOSTED_BASE_URL", "http://127.0.0.1:8082")
SANDBOX_PAYMENT_BASE_URL = _env("SANDBOX_PAYMENT_BASE_URL", "http://127.0.0.1:8081")
