...
function renderPortalLazy(screen: ReactNode) {
  return <Suspense fallback={<AgencyModuleFallback />}>{screen}</Suspense>;
}
...
export function renderProductScreen(
  ...
  if (portal === "agency") {
    ...
    if (route in agencyScreens) {
      return renderPortalLazy(agencyScreens[route]);
    }
  }
  ...
  if (portal === "customer") {
    ...
    if (route in customerScreens) {
      return renderPortalLazy(customerScreens[route]);
    }
  }
